...
export const generateVideo = async function (videoPath, subtitlePath, resultPath) {
    const video = await new FFmpeg(videoPath);
    console.log(video)
    video.addCommand(
        "-vf",
        `subtitles='${subtitlePath}':force_style='FontName=Arial,FontSize=24,PrimaryColour=&H0000FF&,BackColour=&HFFFF00&,Bold=1'`
    );
    // video.addCommand(
    //     "-vf",
